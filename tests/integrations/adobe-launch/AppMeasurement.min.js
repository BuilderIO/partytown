...
function AppMeasurement(e) {
  ...
  (t.log = function (e) {
    ...
    (t.escape = function (e) {
      ...
      for (e = encodeURIComponent(e), a = 0; 7 > a; a++)
        (n = "+~!*()'".substring(a, a + 1)),
          0 <= e.indexOf(n) &&
            (e = t.replace(e, n, '%' + n.charCodeAt(0).toString(16).toUpperCase()));
      return e;
    }),
    ...
    (t.Nb = function () {
      ...
      if (
        ...
        n &&
          !t.Ka &&
          !/^[0-9.]+$/.test(n) &&
          ((i = 2 < (i = i ? parseInt(i) : 2) ? i : 2), 0 <= (e = n.lastIndexOf('.'))))
      ) {
    ...
    (t.c_r = t.cookieRead =
      function (e) {
        ...
        var a = ' ' + t.d.cookie,
          ...
          i = 0 > n ? n : a.indexOf(';', n);
        return '[[B]]' !=
          (e = 0 > n ? '' : t.unescape(a.substring(n + 2 + e.length, 0 > i ? a.length : i)))
          ? e
          : '';
      }),
    (t.c_w = t.cookieWrite =
        ...
        return (
          ...
          n &&
            ...
            ((i = '' != a ? parseInt(o || 0) : -60)
              ...
              : 1 === n &&
                ((i = (n = new Date()).getYear()), n.setYear(i + 2 + (1900 > i ? 1900 : 0)))),
          e && 'NONE' != o
            ? ((t.d.cookie =
                t.escape(e) +
                '=' +
                t.escape('' != a ? a : '[[B]]') +
                '; path=/;' +
                (n && 'SESSION' != o ? ' expires=' + n.toUTCString() + ';' : '') +
                (r ? ' domain=' + r + ';' : '') +
    ...
    (t.ea = function (e, a, n) {
      ...
      return i && (t.K.push({ m: e, a: a, t: r }), t.fa || setTimeout(t.delayReady, t.maxDelay)), i;
    }),
      ...
      function (e) {
        ...
        if (!t.ea('setAccount', arguments))
          if (((t.account = e), t.allAccounts))
            for (
              a = t.allAccounts.concat(e.split(',')), t.allAccounts = [], a.sort(), n = 0;
              n < a.length;
              n++
            )
    ...
    (t.foreachVar = function (e, a) {
      ...
      for (
        r = i = '',
          t.lightProfileID
            ? ((n = t.O), (c = t.lightTrackVars) && (c = ',' + c + ',' + t.ka.join(',') + ','))
            : ((n = t.g),
              (t.pe || t.linkType) &&
                ((c = t.linkTrackVars),
                (i = t.linkTrackEvents),
                    ...
                    default:
                      t.Ra(l) &&
                        ('prop' == s
                          ...
                          : 'list' == s
                          ? (o = 'l' + l)
                          : 'hier' == s && ((o = 'h' + l), (c = c.substring(0, 255))));
                  }
    ...
    (t.Qb = function () {
      ...
      if (
        (t.lightProfileID
          ? ((e = t.O), (f = t.lightTrackVars) && (f = ',' + f + ',' + t.ka.join(',') + ','))
          : ((e = t.g),
            (t.pe || t.linkType) &&
              ((f = t.linkTrackVars),
              (p = t.linkTrackEvents),
      ...
      for (
        ...
        if (
          ...
          o ||
            ('events' == r && g
              ? ((o = g), (g = ''))
              : 'marketingCloudOrgID' == r && d && t.H('ECID') && (o = d.marketingCloudOrgID)),
          o && (!f || 0 <= f.indexOf(',' + r + ',')))
        ) {
          switch (r) {
            ...
            case 'pageURL':
              (r = 'g'),
                255 < o.length && ((t.pageURLRest = o.substring(255)), (o = o.substring(0, 255)));
              break;
            case 'pageURLRest':
              r = '-g';
              break;
    ...
    (t.B = function (e) {
      var t = e.tagName;
      return 'undefined' != '' + e.lc ||
        ('undefined' != '' + e.Zb && 'HTML' != ('' + e.Zb).toUpperCase())
        ? ''
        : ('SHAPE' == (t = t && t.toUpperCase ? t.toUpperCase() : '') && (t = ''),
          t &&
    ...
    (t.Na = function (e) {
      ...
      return (
        ...
        o &&
          (0 > t || (0 <= n && t > n) || (0 <= i && t > i)) &&
          ((n = e.protocol && 1 < e.protocol.length ? e.protocol : r.protocol ? r.protocol : ''),
          (t = r.pathname.lastIndexOf('/')),
          (o =
            (n ? n + '//' : '') +
            (e.host ? e.host : r.host ? r.host : '') +
            ('/' != o.substring(0, 1) ? r.pathname.substring(0, 0 > t ? 0 : t) + '/' : '') +
            o)),
        o
      );
    }),
    (t.L = function (e) {
      ...
      return i &&
        ...
        (n && a && !(0 > a.toLowerCase().indexOf('javascript')))
          ? n
            ? ((r = t.replace(
                t.replace(t.replace(t.replace('' + n, '\r', ''), '\n', ''), '\t', ''),
                ' ',
                ''
              )),
              (o = 2))
    ...
    (t.jc = function (e) {
      for (var a = t.B(e), n = t.L(e); e && !n && 'BODY' != a; )
        (e = e.parentElement ? e.parentElement : e.parentNode) && ((a = t.B(e)), (n = t.L(e)));
      return (
        (n && 'BODY' != a) || (e = 0),
        e &&
    ...
    (t.Yb = function () {
      ...
      if (((t.la = 1), o || ((t.la = 0), (o = t.clickObject)), o)) {
        for (e = t.B(o), n = t.L(o); o && !n && 'BODY' != e; )
          (o = o.parentElement ? o.parentElement : o.parentNode) && ((e = t.B(o)), (n = t.L(o)));
      ...
      if (
        ...
        if (
          ...
          ((l = s.toLowerCase()),
          t.Qa(l) &&
            (t.linkInternalFilters || (t.linkInternalFilters = a.location.hostname),
            (i = 0),
            t.linkExternalFilters
              ? ((i = t.linkExternalFilters.toLowerCase().split(',')), (f = 1))
              : t.linkInternalFilters && (i = t.linkInternalFilters.toLowerCase().split(',')),
            i))
        ) {
    ...
    (t.Rb = function () {
      ...
      if (
        (a &&
          ...
          (e = 1)),
        t.abort && (e = 0),
        t.trackClickMap || t.trackInlineStats || t.Ub())
      ) {
        (a = {}), (n = 0);
        var r,
          o,
            ...
            if (!Object.prototype[o])
              for (c = 0; c < i.length; c++)
                for (
                  ...
                  (s = a[o][r]) == i[c] &&
                    (l &&
                      (t.e += '&u=' + t.escape(s) + ('&' != o.charAt(0) ? '&' : '') + o + '&u=0'),
                    a[o].splice(r, 1),
                    (n = 1));
          if ((e || (n = 1), n)) {
            for (o in ((l = ''),
            (r = 2),
            !e && t.e && ((l = t.escape(i.join(',')) + '=' + t.escape(t.e)), (r = 1)),
            a))
              !Object.prototype[o] &&
                0 < r &&
                0 < a[o].length &&
                ((l += (l ? '&' : '') + t.escape(a[o].join(',')) + '=' + t.escape(o)), r--);
            t.zb(l);
          }
        }
      }
    ...
    (t.zb = function (e) {
      t.useLinkTrackSessionStorage
        ? t.Ea() && a.sessionStorage.setItem(t.P, e)
        : t.cookieWrite(t.P, e);
    }),
    (t.Sb = function () {
      if (!t.bc) {
        ...
        (e = screen.width + 'x' + screen.height),
          ...
          (o = t.w.innerWidth ? t.w.innerWidth : t.d.documentElement.offsetWidth),
          (s = t.w.innerHeight ? t.w.innerHeight : t.d.documentElement.offsetHeight);
        try {
    ...
    (t.loadModule = function (e, n) {
      var i = t.Q[e];
      if (!i) {
        (i = a['AppMeasurement_Module_' + e] ? new a['AppMeasurement_Module_' + e](t) : {}),
          (t.Q[e] = t[e] = i),
          (i.kb = function () {
            return i.ub;
          }),
        ...
        try {
          Object.defineProperty
            ? Object.defineProperty(i, 'onLoad', { get: i.kb, set: i.Ab })
            : (i._olc = 1);
        } catch (e) {
          i._olc = 1;
        }
    ...
    (t.Vb = function () {
      var e = Math.floor(1e13 * Math.random()),
        ...
        i =
          ((n =
            's_vsn_' + (t.visitorNamespace ? t.visitorNamespace : t.account) + (n ? '_' + n : '')),
          t.cookieRead(n));
      if (a) {
    ...
    (t.S = function (e, a) {
      ...
      for (l = {}, n = 0; 2 > n; n++)
        for (i = 0 < n ? t.Ga : t.g, r = 0; r < i.length; r++)
          if ((c = e[(o = i[r])]) || e['!' + o]) {
            if (c && !a && ('contextData' == o || 'retrieveLightData' == o) && t[o])
    ...
    (t.hc = function (e) {
      var a, n, i, r;
      for (a = 0; 2 > a; a++)
        for (n = 0 < a ? t.Ga : t.g, i = 0; i < n.length; i++)
          (e[(r = n[i])] = t[r]),
            e[r] ||
      ...
      if (
        ...
        if ((e = o.split('&')) && 1 < e.length) {
          for (n = 0; n < e.length; n++)
            0 < (a = (i = e[n]).indexOf('=')) && 0 <= c.indexOf(',' + i.substring(0, a) + ',')
              ? (s += (s ? '&' : '') + i)
              : (l += (l ? '&' : '') + i);
          s && l ? (o = s + '&' + l) : (l = '');
        }
        e =
          t + (0 < (a = 253 - (o.length - l.length) - t.length) ? r.substring(0, a) : '') + '?' + o;
      }
      return e;
    }),
    (t.eb = function (e) {
    ...
    (t.qb = function () {
      ...
      return (
        !e ||
        !e.getVisitorValues ||
        (t.X && ((t.X = !1), t.I || ((t.I = !0), e.getVisitorValues(t.Db))), !t.I)
      );
    }),
    (t.T = function () {
      var e = t.visitor;
    ...
    (t.p = function () {
      var e;
      if (t.isReadyToTrack() && (t.Bb(), t.j != n))
    ...
    (t.Fa = function (e) {
      ...
      e && (n = t.S(e, 1)),
        t.Vb() &&
          ...
          t.account &&
            (t.abort ||
              (t.trackOffline && !t.timestamp && (t.timestamp = Math.floor(i.getTime() / 1e3)),
              (e = a.location),
            ...
            t.Rb() &&
              ...
              t.ma('SDID:', t.supplementalDataID),
              t.ma('\tTARGET optIn:', t.H('TARGET')),
              t.ma('\ts.expectSupplementalData:', t.expectSupplementalData),
              t.H('AAM') || (t.contextData['cm.ssf'] = 1),
              t.Sb(),
              t.wb(),
              (o += t.Qb()),
              t.sb(r, o),
    ...
    (t.ab = function () {
      (t.contextData.excCodes = t.contextData.excCodes ? t.contextData.excCodes : []),
    ...
    (t.registerPreTrackCallback = function (e) {
      ...
      'function' == typeof e
        ? t.Ca.push([e, a])
        : t.debugTracking && t.log('Warning, Non function type passed to registerPreTrackCallback');
    }),
    (t.hb = function (e) {
      t.va(t.Ca, e);
    }),
    ...
    (t.registerPostTrackCallback = function (e) {
      ...
      'function' == typeof e
        ? t.Ba.push([e, a])
        : t.debugTracking &&
          t.log('Warning, Non function type passed to registerPostTrackCallback');
    }),
    (t.gb = function (e) {
      t.va(t.Ba, e);
    }),
    ...
    (t.trackLight = function (e, a, n, i) {
      return (
        (t.lightProfileID = e), (t.lightStoreForSeconds = a), (t.lightIncrementBy = n), t.track(i)
      );
    }),
    ...
    (t.sb = function (e, a) {
      var n =
        ...
        e +
        '?AQB=1&ndh=1&pf=1&' +
        (t.za() ? 'callback=s_c_il[' + t._in + '].doPostbacks&et=1&' : '') +
        a +
        '&AQE=1';
      t.hb(n), t.fb(n), t.U();
    }),
        ...
        if (
          ...
          for (var a = 0; a < e.dests.length; ++a) {
            ...
            'object' == typeof n &&
              ...
              'string' == typeof n.id &&
              'aa.' == n.id.substr(0, 3) &&
              ((t.qa[n.id] = new Image()), (t.qa[n.id].alt = ''), (t.qa[n.id].src = n.c));
          }
    }),
    (t.fb = function (e) {
    ...
    (t.U = function () {
      if (!t.l || (t.v && t.v.complete && t.v.C && t.v.R(), !t.l))
        if (((t.Pa = n), t.oa)) t.ia > t.N && t.Wa(t.i), t.ra(500);
        else {
          var e = t.Fb();
    ...
    (t.Fb = function () {
      ...
      return !t.trackOffline || 0 >= t.offlineThrottleDelay
        ? 0
        : ((e = t.A() - t.Ua), t.offlineThrottleDelay < e ? 0 : t.offlineThrottleDelay - e);
    }),
    (t.Ma = function () {
  ...
  for (
    o && 'y' == o.x
      ...
      t.$b = function (e) {
        ...
        if (
          ...
          !i &&
            t.xa() &&
            2047 < e.length &&
            (t.bb() && ((r = 2), (i = new XMLHttpRequest())),
            i &&
              ((t.AudienceManagement && t.AudienceManagement.isReady()) || 0 != t.usePostbacks) &&
              (t.W ? (i.Ha = !0) : (i = 0))),
          !i && t.fc && (e = e.substring(0, 2047)),
          !i &&
            t.d.createElement &&
            (0 != t.usePostbacks || (t.AudienceManagement && t.AudienceManagement.isReady())) &&
            (i = t.d.createElement('SCRIPT')) &&
            ('async' in i) &&
            ((o = (o = t.d.getElementsByTagName('HEAD')) && o[0] ? o[0] : t.d.body)
              ? ((i.type = 'text/javascript'), i.setAttribute('async', 'async'), (r = 3))
              : (i = 0)),
          i ||
            (((i = new Image()).alt = ''),
            i.abort ||
          ...
          (i.onabort =
            ...
            i.ga =
              function () {
                i.Ja(),
                  (t.trackOffline || t.oa) && t.l && t.i.unshift(t.Ib),
                  (t.l = 0),
                  t.ia > t.N && t.Wa(t.i),
                  t.ca(),
                  t.ra(500);
      ...
      t.setTagContainer = function (e) {
        var a, n, i;
        for (t.ac = e, a = 0; a < t._il.length; a++)
          if ((n = t._il[a]) && 's_l' == n._c && n.tagContainerName == e) {
            if ((t.S(n), n.lmq))
              for (a = 0; a < n.lmq.length; a++) (i = n.lmq[a]), t.loadModule(i.n);
            if (n.ml)
              for (i in n.ml)
                if (t[i])
                  for (a in ((e = t[i]), (i = n.ml[i])))
                    !Object.prototype[a] &&
                      ('function' != typeof i[a] || 0 > ('' + i[a]).indexOf('s_c_il')) &&
                      (e[a] = i[a]);
            if (n.mmq)
            ...
            e && n
              ? 0 > (o = (n = '' + n).indexOf('?'))
                ...
                : ((n = i + n.substring(o + 1) + i),
                  r && (0 <= n.indexOf(i + e + i) || 0 <= n.indexOf(i + e + '=' + i))
                    ? void 0
                    : (0 <= (o = n.indexOf('#')) && (n = n.substr(0, o) + i),
                      0 > (o = n.indexOf(i + e + '=')) ||
                        (0 <= (o = (n = n.substring(o + i.length + e.length + 1)).indexOf(i)) &&
                          (n = n.substring(0, o)),
  ...
  (i =
          ...
          ? ((t.r = function (e) {
                ...
                if (t.Ia) {
                  if (!t.useForcedLinkTracking)
                    return (
                      ...
                      void (t.Ia = t.useForcedLinkTracking = 0)
                    );
                ...
                try {
                  if (
                    ...
                    if (
                      ...
                      (r = t.Oa()),
                      t.track(),
                      r < t.Oa() && t.useForcedLinkTracking && e.target)
                    ) {
                      for (
                        o = e.target;
                        o &&
            ...
            t.b && t.b.attachEvent
              ...
              : t.b &&
                ...
                (navigator &&
                  ((0 <= navigator.userAgent.indexOf('WebKit') && t.d.createEvent) ||
                    (0 <= navigator.userAgent.indexOf('Firefox/2') && a.MouseEvent)) &&
                  ((t.Ia = 1),
    ...
    t.mc ||
      (e
        ? t.setAccount(e)
        : t.log('Error, missing Report Suite ID in AppMeasurement initialization'),
      t.Xa(),
